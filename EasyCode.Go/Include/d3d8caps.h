...
D3DCAPS8 STRUCT
	...
	LineCaps DD
	MaxTextureWidth, MaxTextureHeight DD
	MaxVolumeExtent DD
	MaxTextureRepeat DD
	MaxTextureAspectRatio DD
	MaxAnisotropy DD
	MaxVertexW FLOAT // FLOAT
	GuardBandLeft FLOAT // FLOAT
	GuardBandTop FLOAT // FLOAT
	GuardBandRight FLOAT // FLOAT
	GuardBandBottom FLOAT // FLOAT
	ExtentsAdjust FLOAT // FLOAT
	StencilCaps DD
	FVFCaps DD
	TextureOpCaps DD
	...
	MaxPixelShaderValue FLOAT // FLOAT
ENDS
