...
Sci_CharacterRange STRUCT
	cpMin LONG
	cpMax LONG
ENDS

Sci_TextRange STRUCT
	chrg Sci_CharacterRange
	lpstrText PTR
ENDS

Sci_TextToFind STRUCT
	chrg Sci_CharacterRange
	lpstrText PTR
...
SCNotification STRUCT
	...
	text PTR	/* SCN_MODIFIED, SCN_USERLISTSELECTION, SCN_AUTOCSELECTION */
