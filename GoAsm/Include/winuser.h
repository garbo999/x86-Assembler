...
#define TIMERV_COALESCING_MAX       0xFFF
...
#define WM_MEDIASTATUSCHANGE 0x0045
...
#define WM_QM_ACTIVATE 0x0060
#define WM_HOOK_DO_CALLBACK 0x0061
#define WM_SYSCOPYDATA 0x0062
...
// EM_ Messages 00B0 - 00DF
// SBM_ Messages 00E0 - 00EF
// BM_ Messages 00F0 - 00FD
...
// CB_ Messages 0140 - 0165
// STM_ Messages 0170 - 0173
// LB_ Messages 0180 - 01B3
// MN_ Messages 01E0 - 01E7
...
#define WM_NCPOINTERCANCEL              0x0244
#define WM_POINTERUPDATE                0x0245
#define WM_POINTERDOWN                  0x0246
#define WM_POINTERUP                    0x0247
#define WM_POINTERCANCEL                0x0248
...
#define WS_EX_NOANIMATION  0x04000000
/* WINCE? */
...
#define EWX_SHUTDOWN_FULL   0x00400000
...
TOUCHPREDICTIONPARAMETERS STRUCT
	...
	dwLatency INT32
	dwSampleTime INT32
	bUseHWTimeStamp INT32
ENDS

#define TOUCHPREDICTIONPARAMETERS_DEFAULT_LATENCY 8
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_SAMPLETIME 8
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_RLS_DELTA 0.001
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_RLS_LAMBDA_MIN 0.9
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_RLS_LAMBDA_MAX 0.999
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_RLS_LAMBDA_LEARNING_RATE 0.001
#define TOUCHPREDICTIONPARAMETERS_DEFAULT_RLS_EXPO_SMOOTH_ALPHA 0.99
...
#define STATE_SYSTEM_INDETERMINATE  0x00000020
...
POINTER_DEVICE_INFO STRUCT
	displayOrientation DD
	device HANDLE
	pointerDeviceType ENUM
	monitor HANDLE
	startingCursorId LONG
	maxActiveContacts SHORT
	productString WCHAR POINTER_DEVICE_PRODUCT_STRING_MAX DUP
ENDS
...
#IFDEF UNICODE
#define ICONINFOEX ICONINFOEXW
#ELSE
#define ICONINFOEX ICONINFOEXA
#ENDIF
...
// Though technically correct the ACCEL structure needs WORD alignment
// so the MSDN version will result in an error, a corrected version is
// supplied instead
;ACCEL STRUCT
;	fVirt DB
;	key DW
...
MULTIKEYHELPA STRUCT
	mkSize DD
	mkKeylist DB
	szKeyphrase DB 1 DUP
ENDS

MULTIKEYHELPW STRUCT
	mkSize DD
	mkKeylist DW
	szKeyphrase DW 1 DUP
ENDS
...
TITLEBARINFOEX STRUCT
	...
	rcTitleBar RECT
	rgstate DD (CCHILDREN_TITLEBAR + 1) DUP
	rgrect DB (CCHILDREN_TITLEBAR + 1)*16 DUP ; RECT
ENDS
...
// POINTER_INPUT_TYPE enumeration
...
// This creates a macro that allows software using CreateWindow
// to be directly compatible
CreateWindowW equ CreateWindowExW,0
CreateWindowA equ CreateWindowExA,0
...
#IFDEF UNICODE
	...
	#define ICONMETRICS ICONMETRICSW
	#define SERIALKEYS SERIALKEYSW
	#define HIGHCONTRAST HIGHCONTRASTW
	#define SOUNDSENTRY SOUNDSENTRYW
...
#define EnumTaskWindows EnumThreadWindows
