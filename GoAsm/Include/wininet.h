...
#define INTERNET_MAX_URL_LENGTH  (INTERNET_MAX_SCHEME_LENGTH+2+INTERNET_MAX_PATH_LENGTH)
...
#define HTTP_VERSIONA  A"HTTP/1.0"
...
GOPHER_FIND_DATAW STRUCT
	DisplayString DW MAX_GOPHER_DISPLAY_TEXT+1 DUP (?)
	GopherType DD
	SizeLow DD
	SizeHigh DD
	LastModificationTime FILETIME
	Locator DW MAX_GOPHER_LOCATOR_LENGTH+1 DUP (?)
ENDS
...
INTERNET_CACHE_ENTRY_INFOA STRUCT
	dwStructSize DD
	lpszSourceUrlName PTR
	lpszLocalFileName PTR
	CacheEntryType DD
	dwUseCount DD
	dwHitRate DD
	dwSizeLow DD
...
INTERNET_CACHE_GROUP_INFOA STRUCT
	...
	szGroupName DB GROUPNAME_MAX_LENGTH DUP (?)
ENDS
...
INTERNET_CACHE_GROUP_INFOW STRUCT
	...
	dwDiskQuota DD
	dwOwnerStorage DD GROUP_OWNER_STORAGE_SIZE DUP (?)
	szGroupName DW GROUPNAME_MAX_LENGTH DUP (?)
ENDS
...
#IFDEF UNICODE
	...
	#define INTERNET_BUFFERS INTERNET_BUFFERSW
	#define GOPHER_FIND_DATA GOPHER_FIND_DATAW
	#define INTERNET_CACHE_ENTRY_INFO INTERNET_CACHE_ENTRY_INFOW
