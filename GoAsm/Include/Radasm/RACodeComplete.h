#IFNDEF RACODECOMPLETE_H
#DEFINE RACODECOMPLETE_H
...
TTM_GETITEMTYPE		equ WM_USER+5			;wParam=0, lParam=lpTTITEM, Returns pointer to string
...
szCCLBClassName	equ 'RACodeComplete',0
szCCTTClassName	equ 'RAToolTip',0
#ENDIF