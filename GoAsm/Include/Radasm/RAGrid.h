...
GN_EDITCHANGE		equ 12			;Sendt when user types text in the edit control.
...
GM_COMBOFINDSTRING	equ WM_USER+45	;wParam=nCol, lParam=lpszString
...
TYPE_EDITCOMBOBOX	equ 11			;String
